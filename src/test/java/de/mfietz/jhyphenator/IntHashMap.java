...
/**
 * From https://github.com/jglick/inthashmap/blob/master/src/main/java/Demo.java
 * Android has SparseArray class, but these tests run in local Java machine.
 * Modified original adding keyAt() method - GKochaniak
 * @param <T>
 */
public class IntHashMap<T> {
     ...
     */
    public IntHashMap(final int expectedSize,
                                  final T missingEntries, Class<T> type) {
        this.type = type;
